  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: <Widget>[
          _buildTile(
              context, "ChatBot", Icons.chat, Colors.blue, ChatBotPage()),
          _buildTile(context, "Settings", Icons.settings, Colors.orange,
              OptionsPage()),
          _buildTile(context, "Timetable", Icons.calendar_today, Colors.green,
              TimetablePage()),
          // 다른 타일들 추가 가능
        ],
      ),
